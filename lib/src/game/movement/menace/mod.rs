...
pub fn menace_of_piece(board: &GameBoard, bounds: &GameBounds, pos: &Pos) -> Vec<Pos> {
...
pub fn menace_of_player(board: &GameBoard, bounds: &GameBounds, color: Color) -> HashSet<Pos> {
