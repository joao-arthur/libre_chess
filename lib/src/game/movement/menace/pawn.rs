...
mod tests {
    ...
    fn menace_lonely_piece() {
        ...
        assert_eq!(menace(&board_white_pawn, &bounds, &Pos::of_str("C5")), pos_of_str_slice(["B6", "D6"]));
        assert_eq!(menace(&board_black_pawn, &bounds, &Pos::of_str("C5")), pos_of_str_slice(["B4", "D4"]));
    }
