use crate::{
    board::pos::Pos,
    color::Color,
    game::{board::GameBoard, movement::movement::EnPassantMovement},
    movement::Movement,
    piece::Type,
};

pub fn movements(board: &GameBoard, history: &Vec<Movement>, pos: &Pos) -> Vec<EnPassantMovement> {
...
mod tests {
    ...
    use crate::{
        board::pos::Pos,
        game::{movement::movement::EnPassantMovement, piece},
        movement::Movement,
    };
