...
mod tests {
    ...
    use crate::{
        ...
        game::{
            ...
            game::GameBounds,
            mode::standard_chess,
            mov::{CaptureMov, DefaultMov, GameMov, MenaceMov, game_move_vec_to_string},
            player::GamePlayer,
        },
        mov::Mov,
        pos::Pos,
    ...
    fn game_of_mode_standard_chess() {
        ...
        assert_eq!(
            game.players.get(&Color::Black),
            Some(&GamePlayer { color: Color::Black, captures: Vec::new(), moves: HashMap::new() }),
        );
